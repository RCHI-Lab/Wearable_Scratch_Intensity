...
def write(output):
    file_object = open(fh_output + 'bc.txt', 'a')
...
for params in combs:
    ...
    filename = fh_output +"bc_labelpreds.pickle"
    ...
    plot_title = "Binary Classification Both Sensors" 
    plt.title(plot_title)

    plt.savefig(fh_output + "bc_both" + ".png")
    plt.clf()
    write(output)
    n+=1
