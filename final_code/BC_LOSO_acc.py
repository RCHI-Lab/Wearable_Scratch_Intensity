...
def write(output):
    file_object = open(fh_output + 'bc_acc.txt', 'a')
...
for params in combs:
    ...
    filename = fh_output +"bc_labelpred_acc.pickle"
    ...
    plot_title = "Binary Classification Accelerometer Only" 
    plt.title(plot_title)

    plt.savefig(fh_output + "bc_acc" + ".png")
    plt.clf()
    write(output)
    n+=1
