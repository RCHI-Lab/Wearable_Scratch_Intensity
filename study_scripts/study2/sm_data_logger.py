...
if eczema == 0: 
    print("AT CMU")
    filenameheader = "/Volumes/T7/mod_dataset/healthy/SM/"
elif eczema == 1:
    print("AT UPMC")
    filenameheader = "/Volumes/T7/mod_dataset/eczema/SM/"
else: 
...
def wearable(participant_num, file_num, num_secs, other_start_time):
    ...
    if skip == 1:
        ...
        filenamestart = filenameheader + 'w_' + str(participant_num) + "_" + str(set_num) + "_"
...
while ind <= size_interactions:
    ...
    if skip == 1: 
        ...
        #write to pickle
        filenamestart = filenameheader + 's_' + str(participant_num) + "_" + str(set_num) + "_"
        filename = filenamestart + str(file_num)
